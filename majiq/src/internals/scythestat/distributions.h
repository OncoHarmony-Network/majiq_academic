...
#include <algorithm>
#include <limits>
#include <math.h> // include std::isfinite instead of finite
...
#undef swap_tail
    ...
    {
      SCYTHE_CHECK_10(! std::isfinite(x), scythe_invalid_arg,
...
//  const double alphlimit = 1000.;/* normal approx. for shape > alphlimit */
