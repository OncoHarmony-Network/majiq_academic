...
$( document ).ready(function(){
    ...
    for ( var lsv=0; lsv<$('.lsvGroupsCompactPercentiles').length; lsv++){
        drawLSVGroupsCompactStackBars($('.lsvGroupsCompactPercentiles')[lsv], 0);
    }

    for (var lsv=0; lsv<$('.lsvGroupsCompactVariance').length; lsv++){
        drawLSVGroupsCompactStackBars($('.lsvGroupsCompactVariance')[lsv], 1);
    }


    for ( var lsv=0; lsv<$('.lsvGroupsCompactPercentilesHue').length; lsv++){
        drawLSVGroupsCompactStackBars($('.lsvGroupsCompactPercentilesHue')[lsv], 2);
    }

    for ( var lsv=0; lsv<$('.lsvGroupsCompactVarianceHue').length; lsv++){
        drawLSVGroupsCompactStackBars($('.lsvGroupsCompactVarianceHue')[lsv], 3);
    }

    for ( var lsv=0; lsv<$('.lsvGroupsCompactPercentilesLeftAligned').length; lsv++){
        drawLSVGroupsCompactStackBars($('.lsvGroupsCompactPercentilesLeftAligned')[lsv], 4);
    }
...
function addExpandedViewFunction(){
    ...
    $('.zoomMatrix').on("click", function(e){
        ...
        var expandIcon;
        if (iconExpand.getAttribute('data-is-expanded') == false){
            expandIcon = "../templates/static/img/zoom_in.png";
        } else {
            expandIcon = "../templates/static/img/zoom_out.png";
        }
    ...
    $('.expandLsv').on("click", function(e){
        ...
        // change icon
        iconExpand.setAttribute('src', expandIcon);
        $($('.lsvGroups').get(0)).toggle("show");
        var targetElement = $($('.lsvGroupsCompactPercentiles').get(0));
        targetElement.toggle("show", function(){
            $(this).get(0).focus();
        });
...
function drawLSVGroups(canvas){
    ...
    function getColor(colorNumber){
        ...
        return rgbToHex(BREWER_PALETTE[colorNumber][0], BREWER_PALETTE[colorNumber][1], BREWER_PALETTE[colorNumber][2]);
...
//        gradient.addColorStop(0,getColor(count));  // This suppress the color gradient
        gradient.addColorStop(1,getColor(count));
    ...
    if (canvas.getContext) {  // check for support
        ...
        // Clear canvas
        ctx.clearRect(0, 0, canvas.width, canvas.height);
//        var groups_str = '{"Brain1": {"quantiles": [0.0085869884077270017, 0.0185507490528867, 0.039331969099260386, 0.070499931202467433, 0.10776128732936643], "mean": 0.7040854774660984}, "Liver1": {"quantiles": [0.0167127755328524, 0.027718954397289025, 0.045679859838293688, 0.068044715851760751, 0.093933591236696534], "mean": 0.051347056627349189}, "CNS1": {"quantiles": [0.0050204656945765352, 0.0094307862661881618, 0.016861982876914608, 0.02711108795391242, 0.039047249315262544], "mean": 0.019890393118988429}, "Liver2": {"quantiles": [0.033018523374089559, 0.052006124437603635, 0.08022851891171659, 0.11349486090515559, 0.15063461121609234], "mean": 0.087625252655997701}, "Brain2": {"quantiles": [0.16696786454087925, 0.23725294831529714, 0.31983500541741855, 0.42557043358099123, 0.52059433186890247], "mean": 0.33619105810705663}}';
        var groups_str = '{"Brain1": {"PSI1": {"quantiles": [0.58558305885339956, 0.64927950284874325, 0.7123383481909511, 0.76410640951310627, 0.81020384655356392], "mean": 0.7040854774660984}, "PSI2": {"quantiles": [0.1399576942378119, 0.18648402982087461, 0.23816476004292436, 0.29543137579707301, 0.36034427584126916], "mean": 0.2456880468921798}, "PSI3": {"quantiles": [0.0085869884077270017, 0.0185507490528867, 0.039331969099260386, 0.070499931202467433, 0.10776128732936643], "mean": 0.05022647564172205}}, "Liver1": {"PSI1": {"quantiles": [0.017312674221672222, 0.027306003129876962, 0.04387031495479439, 0.066852711784719368, 0.09095349084757412], "mean": 0.050121886445342538}, "PSI2": {"quantiles": [0.84268654065686244, 0.87360616269822611, 0.90371812976703758, 0.92839330731234337, 0.94836009037537949], "mean": 0.89853105692730806}, "PSI3": {"quantiles": [0.0167127755328524, 0.027718954397289025, 0.045679859838293688, 0.068044715851760751, 0.093933591236696534], "mean": 0.051347056627349189}}, "CNS1": {"PSI1": {"quantiles": [0.72634413748218041, 0.75492912648127097, 0.78489698300156308, 0.81318882833940087, 0.83444882266707976], "mean": 0.78196816665515079}, "PSI2": {"quantiles": [0.14808838181253248, 0.16819905374556013, 0.19378444116212087, 0.22541219253649442, 0.25354826411316617], "mean": 0.19814144022586128}, "PSI3": {"quantiles": [0.0050204656945765352, 0.0094307862661881618, 0.016861982876914608, 0.02711108795391242, 0.039047249315262544], "mean": 0.019890393118988429}}, "Liver2": {"PSI1": {"quantiles": [0.035286197919954999, 0.05253611937149797, 0.081574971529918078, 0.11692023224409571, 0.15648746333728336], "mean": 0.089254143288114138}, "PSI2": {"quantiles": [0.73424632923438948, 0.78441260247880984, 0.83017998625195932, 0.87020836193544171, 0.90181310236123868], "mean": 0.82312060405588838}, "PSI3": {"quantiles": [0.033018523374089559, 0.052006124437603635, 0.08022851891171659, 0.11349486090515559, 0.15063461121609234], "mean": 0.087625252655997701}}, "Brain2": {"PSI1": {"quantiles": [0.10474716073787305, 0.15545030362768197, 0.2268214264629328, 0.31877883386939282, 0.40346178787707565], "mean": 0.24247623462756193}, "PSI2": {"quantiles": [0.2307375733025599, 0.31663796698787738, 0.41937502332727283, 0.52272833287239551, 0.61401689633784939], "mean": 0.42133270726538152}, "PSI3": {"quantiles": [0.16696786454087925, 0.23725294831529714, 0.31983500541741855, 0.42557043358099123, 0.52059433186890247], "mean": 0.33619105810705663}}}'
...
//        var groups = JSON.parse(canvas.getAttribute('data-groups'));  // Not used at this stage
        ...
        for (var key in groups){
            var num_psis = Object.keys(groups[key]).length;
            break;
        }
        ...
        for (var group_key in groups){
            // X-axis
            drawLine(ctx, origins_coords[i][0]-5, origins_coords[i][1], origins_coords[i][0]+sub_canvas_w-(sub_canvas_margins[0] + sub_canvas_margins[1])+1, origins_coords[i][1]);
            // Y-axis
            drawLine(ctx, origins_coords[i][0], origins_coords[i][1]+5, origins_coords[i][0], sub_canvas_margins[2]);
            var prev_style = ctx.fillStyle;
            var prev_font = ctx.font;
            ctx.fillStyle = "#000000";
            ctx.font = "8pt Arial";
            ctx.fillText("0", origins_coords[i][0]-6, origins_coords[i][1]+10);
            ctx.fillText("1", origins_coords[i][0]-6, origins_coords[i][1]-sub_canvas_pixels[1]+5);
//            ctx.fillStyle = prev_style;
            ...
            for (var psi_name in groups[group_key]){
                var coords_gradient = {
                    'x1': origins_coords[i][0]+offset, 'y1': origins_coords[i][1],
                    'x2': origins_coords[i][0]+offset+sub_canvas_pixels[0]/num_psis, 'y2': origins_coords[i][1]-sub_canvas_pixels[1]};
                ...
                drawRectangle(ctx, origins_coords[i][0]+offset,
                    Math.round(origins_coords[i][1]-group.quantiles[1]*sub_canvas_pixels[1]),
                    sub_canvas_pixels[0]/num_psis,
                    -Math.round((group.quantiles[3]-group.quantiles[1])*sub_canvas_pixels[1]), true
                );
                ctx.strokeRect(origins_coords[i][0]+offset,
                    Math.round(origins_coords[i][1]-group.quantiles[1]*sub_canvas_pixels[1]),
                    sub_canvas_pixels[0]/num_psis,
                    -Math.round((group.quantiles[3]-group.quantiles[1])*sub_canvas_pixels[1]), true
                );
                // 10 and 75 tales
                drawLine(ctx,
                    Math.round(origins_coords[i][0]+offset+sub_canvas_pixels[0]/num_psis/2),
                    Math.round(origins_coords[i][1]-group.quantiles[0]*sub_canvas_pixels[1]),
                    Math.round(origins_coords[i][0]+offset+sub_canvas_pixels[0]/num_psis/2),
                    Math.round(origins_coords[i][1]-group.quantiles[1]*sub_canvas_pixels[1])
                );
                drawLine(ctx,
                    Math.round(origins_coords[i][0]+offset+sub_canvas_pixels[0]/num_psis/2),
                    Math.round(origins_coords[i][1]-group.quantiles[3]*sub_canvas_pixels[1]),
                    Math.round(origins_coords[i][0]+offset+sub_canvas_pixels[0]/num_psis/2),
                    Math.round(origins_coords[i][1]-group.quantiles[4]*sub_canvas_pixels[1])
                );

                // Median (50 percentile)
                drawLine(ctx, origins_coords[i][0]+offset, Math.round(origins_coords[i][1]-group.quantiles[2]*sub_canvas_pixels[1]),
                    origins_coords[i][0]+offset+sub_canvas_pixels[0]/num_psis,
                    Math.round(origins_coords[i][1]-group.quantiles[2]*sub_canvas_pixels[1]));

                // Mean
                ctx.lineWidth = 2;
                ctx.strokeStyle = rgbToHex(197,27,138);
                drawLine(ctx, origins_coords[i][0]+offset, Math.round(origins_coords[i][1]-group.mean*sub_canvas_pixels[1]), origins_coords[i][0]+offset+sub_canvas_pixels[0]/num_psis, Math.round(origins_coords[i][1]-group.mean*sub_canvas_pixels[1]));
                ctx.strokeStyle = "#000000";
                ctx.lineWidth = 1;
                ...
                if (count < num_psis){
                    ctx.lineWidth = .5;
                    drawDashedLine(ctx, origins_coords[i][0]+offset, sub_canvas_margins[2]-sub_canvas_margins[2] *.1, origins_coords[i][0]+offset, canvas.height-sub_canvas_margins[3] *.2, 1);
                }
                ctx.lineWidth = 1;
                ctx.fillStyle = '#000000';
                ctx.font = '8pt Arial';
                ctx.fillText(psi_name, origins_coords[i][0]+offset-sub_canvas_pixels[0]/num_psis/2, canvas.height-sub_canvas_margins[3] *.5);
...
function drawLSVGroupsCompactStackBars(canvas, fillMode){
    // Get Color from Brewer Palette
    BREWER_PALETTE = [
        [228,26,28],
        [55,126,184],
...
//        return rgbToHex(palette[colorNumber][0], palette[colorNumber][1], palette[colorNumber][2]);
    ...
    function createGradientLSVGroupsCompact(coords, group, count, fillMode, hue) {
        ...
        if (fillMode < 2 || fillMode === 4){
            ...
            if (hue)
            {
                ...
                var newHue = 1;
                if (fillMode === 2){
                    newHue = 1- (group.quantiles[4]-group.quantiles[0]);
                } else {
                    newHue = 1-group.var;
                }
    ...
    var fillingPSIArea = function (ctx, fillMode, group, x1, y1, x2, y2) {
        var area = [];
        if (fillMode === 0){
            // Fill from center to both left and right
            // First approach, use 1 - the 25 to 75 percentile to fill the area
            area[0] = Math.round((1 - (group.quantiles[4] - group.quantiles[0])) * (x2 - x1));
            area[1] = y2 - y1;
...
//            ctx.strokeRect(x1+(x2-x1-area[0])/2, y1, area[0], area[1]);
            ...
            area[0] = Math.round((1 - group.var) * (x2 - x1));
            area[1] = y2 - y1;
            ctx.strokeStyle = ctx.fillStyle;
            drawRectangle(ctx, x1+(x2-x1-area[0])/2, y1, area[0], area[1], true);
//            ctx.strokeRect(x1+(x2-x1-area[0])/2, y1, area[0], area[1]);
...
//        var groups_str = '{"Brain1": {"quantiles": [0.0085869884077270017, 0.0185507490528867, 0.039331969099260386, 0.070499931202467433, 0.10776128732936643], "mean": 0.7040854774660984}, "Liver1": {"quantiles": [0.0167127755328524, 0.027718954397289025, 0.045679859838293688, 0.068044715851760751, 0.093933591236696534], "mean": 0.051347056627349189}, "CNS1": {"quantiles": [0.0050204656945765352, 0.0094307862661881618, 0.016861982876914608, 0.02711108795391242, 0.039047249315262544], "mean": 0.019890393118988429}, "Liver2": {"quantiles": [0.033018523374089559, 0.052006124437603635, 0.08022851891171659, 0.11349486090515559, 0.15063461121609234], "mean": 0.087625252655997701}, "Brain2": {"quantiles": [0.16696786454087925, 0.23725294831529714, 0.31983500541741855, 0.42557043358099123, 0.52059433186890247], "mean": 0.33619105810705663}}';
//        var groups_str = '{"Brain1": {"PSI1": {"quantiles": [0.58558305885339956, 0.64927950284874325, 0.7123383481909511, 0.76410640951310627, 0.81020384655356392], "mean": 0.7040854774660984}, "PSI2": {"quantiles": [0.1399576942378119, 0.18648402982087461, 0.23816476004292436, 0.29543137579707301, 0.36034427584126916], "mean": 0.2456880468921798}, "PSI3": {"quantiles": [0.0085869884077270017, 0.0185507490528867, 0.039331969099260386, 0.070499931202467433, 0.10776128732936643], "mean": 0.05022647564172205}}, "Liver1": {"PSI1": {"quantiles": [0.017312674221672222, 0.027306003129876962, 0.04387031495479439, 0.066852711784719368, 0.09095349084757412], "mean": 0.050121886445342538}, "PSI2": {"quantiles": [0.84268654065686244, 0.87360616269822611, 0.90371812976703758, 0.92839330731234337, 0.94836009037537949], "mean": 0.89853105692730806}, "PSI3": {"quantiles": [0.0167127755328524, 0.027718954397289025, 0.045679859838293688, 0.068044715851760751, 0.093933591236696534], "mean": 0.051347056627349189}}, "CNS1": {"PSI1": {"quantiles": [0.72634413748218041, 0.75492912648127097, 0.78489698300156308, 0.81318882833940087, 0.83444882266707976], "mean": 0.78196816665515079}, "PSI2": {"quantiles": [0.14808838181253248, 0.16819905374556013, 0.19378444116212087, 0.22541219253649442, 0.25354826411316617], "mean": 0.19814144022586128}, "PSI3": {"quantiles": [0.0050204656945765352, 0.0094307862661881618, 0.016861982876914608, 0.02711108795391242, 0.039047249315262544], "mean": 0.019890393118988429}}, "Liver2": {"PSI1": {"quantiles": [0.035286197919954999, 0.05253611937149797, 0.081574971529918078, 0.11692023224409571, 0.15648746333728336], "mean": 0.089254143288114138}, "PSI2": {"quantiles": [0.73424632923438948, 0.78441260247880984, 0.83017998625195932, 0.87020836193544171, 0.90181310236123868], "mean": 0.82312060405588838}, "PSI3": {"quantiles": [0.033018523374089559, 0.052006124437603635, 0.08022851891171659, 0.11349486090515559, 0.15063461121609234], "mean": 0.087625252655997701}}, "Brain2": {"PSI1": {"quantiles": [0.10474716073787305, 0.15545030362768197, 0.2268214264629328, 0.31877883386939282, 0.40346178787707565], "mean": 0.24247623462756193}, "PSI2": {"quantiles": [0.2307375733025599, 0.31663796698787738, 0.41937502332727283, 0.52272833287239551, 0.61401689633784939], "mean": 0.42133270726538152}, "PSI3": {"quantiles": [0.16696786454087925, 0.23725294831529714, 0.31983500541741855, 0.42557043358099123, 0.52059433186890247], "mean": 0.33619105810705663}}}'
        var groups_str = '{"Brain1": {"PSI1": {"var": 0.0074555154779834577, "quantiles": [0.58558305885339956, 0.64927950284874325, 0.7123383481909511, 0.76410640951310627, 0.81020384655356392], "mean": 0.7040854774660984}, "PSI2": {"var": 0.0068315643838000482, "quantiles": [0.1399576942378119, 0.18648402982087461, 0.23816476004292436, 0.29543137579707301, 0.36034427584126916], "mean": 0.2456880468921798}, "PSI3": {"var": 0.0016758508559471695, "quantiles": [0.0085869884077270017, 0.0185507490528867, 0.039331969099260386, 0.070499931202467433, 0.10776128732936643], "mean": 0.05022647564172205}}, "Liver1": {"PSI1": {"var": 0.0008928339892878025, "quantiles": [0.017312674221672222, 0.027306003129876962, 0.04387031495479439, 0.066852711784719368, 0.09095349084757412], "mean": 0.050121886445342538}, "PSI2": {"var": 0.0017652980221384569, "quantiles": [0.84268654065686244, 0.87360616269822611, 0.90371812976703758, 0.92839330731234337, 0.94836009037537949], "mean": 0.89853105692730806}, "PSI3": {"var": 0.00099690656783313412, "quantiles": [0.0167127755328524, 0.027718954397289025, 0.045679859838293688, 0.068044715851760751, 0.093933591236696534], "mean": 0.051347056627349189}}, "CNS1": {"PSI1": {"var": 0.001790118326605698, "quantiles": [0.72634413748218041, 0.75492912648127097, 0.78489698300156308, 0.81318882833940087, 0.83444882266707976], "mean": 0.78196816665515079}, "PSI2": {"var": 0.0017024220254318967, "quantiles": [0.14808838181253248, 0.16819905374556013, 0.19378444116212087, 0.22541219253649442, 0.25354826411316617], "mean": 0.19814144022586128}, "PSI3": {"var": 0.00019317205946046349, "quantiles": [0.0050204656945765352, 0.0094307862661881618, 0.016861982876914608, 0.02711108795391242, 0.039047249315262544], "mean": 0.019890393118988429}}, "Liver2": {"PSI1": {"var": 0.0023980329456464657, "quantiles": [0.035286197919954999, 0.05253611937149797, 0.081574971529918078, 0.11692023224409571, 0.15648746333728336], "mean": 0.089254143288114138}, "PSI2": {"var": 0.0043719250933379064, "quantiles": [0.73424632923438948, 0.78441260247880984, 0.83017998625195932, 0.87020836193544171, 0.90181310236123868], "mean": 0.82312060405588838}, "PSI3": {"var": 0.0023261733084575485, "quantiles": [0.033018523374089559, 0.052006124437603635, 0.08022851891171659, 0.11349486090515559, 0.15063461121609234], "mean": 0.087625252655997701}}, "Brain2": {"PSI1": {"var": 0.013894101212886185, "quantiles": [0.10474716073787305, 0.15545030362768197, 0.2268214264629328, 0.31877883386939282, 0.40346178787707565], "mean": 0.24247623462756193}, "PSI2": {"var": 0.020538079779782795, "quantiles": [0.2307375733025599, 0.31663796698787738, 0.41937502332727283, 0.52272833287239551, 0.61401689633784939], "mean": 0.42133270726538152}, "PSI3": {"var": 0.018431257833960251, "quantiles": [0.16696786454087925, 0.23725294831529714, 0.31983500541741855, 0.42557043358099123, 0.52059433186890247], "mean": 0.33619105810705663}}}'
...
//        var groups = JSON.parse(canvas.getAttribute('data-groups'));  // Not used at this stage
        ...
        var sub_canvas_w = canvas.width / num_groups;
        var sub_canvas_h = canvas.height-header_height;
        var sub_canvas_margins = [sub_canvas_w *.00, 0, header_height+sub_canvas_h*0, sub_canvas_h *.21];
        var sub_canvas_pixels = [sub_canvas_w-sub_canvas_margins[0] -sub_canvas_margins[1], canvas.height-sub_canvas_margins[3]-sub_canvas_margins[2]];
...
//        drawLine(ctx, 0, sub_canvas_h-sub_canvas_margins[3], canvas.width, sub_canvas_h-sub_canvas_margins[3]);
        ...
        for (var key in groups){
            ...
            i++;
            ctx.fillText(key,sub_canvas_w*(i-1/2), sub_canvas_h-sub_canvas_margins[3]+sub_canvas_h*.2 - 1);
        }
...
//            drawLine(ctx, origins_coords[i][0]-5, origins_coords[i][1], origins_coords[i][0]+sub_canvas_w-(sub_canvas_margins[0] + sub_canvas_margins[1])+1, origins_coords[i][1]);
            // Y-axis
//            drawLine(ctx, origins_coords[i][0], origins_coords[i][1]+1, origins_coords[i][0], sub_canvas_margins[2]);
//            var prev_style = ctx.fillStyle;
//            var prev_font = ctx.font;
//            ctx.fillStyle = "#000000";
//            ctx.font = "7pt Arial";
//            ctx.fillText("0", origins_coords[i][0]-5, origins_coords[i][1]);
//            ctx.fillText("1", origins_coords[i][0]-6, origins_coords[i][1]-sub_canvas_pixels[1]+5);
//            ctx.fillStyle = prev_style;
//            ctx.font = prev_font;
            ...
            for (var psi_name in groups[group_key]){
                ...
                acc_height += group.mean;

                var coords_gradient = {
                    'x1': origins_coords[i][0]+offset, 'y1': origins_coords[i][1],
                    'x2': origins_coords[i][0]+offset+sub_canvas_pixels[0], 'y2': origins_coords[i][1]-sub_canvas_pixels[1]};
                ctx.fillStyle = createGradientLSVGroupsCompact(coords_gradient, group, count, fillMode);
                ctx.strokeStyle = createGradientLSVGroupsCompact(coords_gradient, group, count, fillMode,1);

                // Filling the PSI area
                fillingPSIArea(ctx, fillMode, group, origins_coords[i][0], origins_coords[i][1] - (acc_height-group.mean)*sub_canvas_pixels[1], origins_coords[i][0]+sub_canvas_pixels[0], origins_coords[i][1] - (acc_height)*sub_canvas_pixels[1]);

//                if (count < num_psis-1){
//                    // Mean line
//                    ctx.lineWidth = .8;
//                    ctx.strokeStyle = "#000000";
//                    drawDashedLine(ctx, origins_coords[i][0]-2, Math.round(origins_coords[i][1]-acc_height*sub_canvas_pixels[1]), origins_coords[i][0]+sub_canvas_pixels[0], Math.round(origins_coords[i][1]-acc_height*sub_canvas_pixels[1]));
//                    ctx.strokeStyle = "#000000";
//                    ctx.lineWidth = 1;
//                }
...
function drawLSEBoxplots(canvas) {
    if (canvas.getContext) {  // check for support
        ...
        var arrayBins = JSON.parse(canvas.getAttribute('data-array-bins'));
        var arrayQuartiles = JSON.parse(canvas.getAttribute('data-array-quartiles'));
        var arrayMeansPsi = JSON.parse(canvas.getAttribute('data-array-means'));
        var arrayNames = JSON.parse(canvas.getAttribute('data-array-names').replace(/'/g, '\"'));
...
//        var ctx = lineCharts.get(i).getContext("2d");
//
//        var data = {
//            labels : [
//                "-1","","","","","","","","","",
...
//                    strokeColor : "rgba(228,26,28,1)",
//                    pointColor : "rgba(228,26,28,1)",
//                    pointStrokeColor : "#fff",
//                    data : map(function(x) { return mul(x, 100);}, JSON.parse(lineCharts.get(i).getAttribute('data-bins1')))
//                }
////                ,
////                {
////                    fillColor : "rgba(24,68,242,0.5)",
////                    strokeColor : "rgba(24,68,242,1)",
////                    pointColor : "rgba(24,68,242,1)",
////                    pointStrokeColor : "#fff",
////                    data : [28,48,40,19,20,27,90,28,48,40,
////                        28,48,40,19,20,27,90,28,48,40,
////                        28,48,40,19,20,27,90,28,48,40,
////                        28,48,40,19,20,27,90,28,48,40]
////                }
//            ]
