...
def deltapsi(args):
    ...
    majiq_output = utils_voila.lsvs_to_gene_dict(voila_lsvs,
                                                 metainfo,
...
def render_html(args, majiq_output):
    """
    Render html output for deltapsi.
    :param args: command line arguments
    :param majiq_output: dictionary of majiq output values
    :return: None
    """
