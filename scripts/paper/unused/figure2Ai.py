...
def main():
    ...
    # python ~/Projects/old_majiq/scripts/paper/figureAi.py --old_majiq old_majiq/ --miso miso/ --names Hip1 Hip2 Hip1 Hip4 Hip5 Hip6 Liv1 Liv2 Liv1 Liv4 Liv4 Liv5 --plotpath ./output/
