...
class Events:
    ...
    def event_has_ref_alt_ss(
        self, event_idx: npt._ArrayLikeInt_co
    ) -> npt.NDArray[numpy.bool_]: ...
...
class Exons:
    ...
    def checksum(self) -> int: ...
    def overlaps(
        self, exon_idx: npt._ArrayLikeInt_co, other: Exons
    ) -> npt.NDArray[numpy.bool_]: ...
    def index(
        self,
        gene_idx: npt._ArrayLikeInt_co,
...
class GeneIntrons:
    ...
    def overlaps(
        self, gi_idx: npt._ArrayLikeInt_co, other: GeneIntrons
    ) -> npt.NDArray[numpy.bool_]: ...
    def index(
        self,
        gene_idx: npt._ArrayLikeInt_co,
...
class GeneJunctions:
    ...
    def connect_exons(self, exons: Exons) -> None: ...
    def overlaps(
        self, gj_idx: npt._ArrayLikeInt_co, other: GeneJunctions
    ) -> npt.NDArray[numpy.bool_]: ...
    def index(
        self,
        gene_idx: npt._ArrayLikeInt_co,
...
class Genes:
    ...
    def __len__(self) -> int: ...
    def overlaps(
        self, gene_idx: npt._ArrayLikeInt_co, other: Genes
    ) -> npt.NDArray[numpy.bool_]: ...
    @property
    def _parent_idx_end(self) -> npt.NDArray[numpy.uint64]: ...
    @property
...
class SJIntrons:
    ...
    def overlaps(
        self, si_idx: npt._ArrayLikeInt_co, other: SJIntrons
    ) -> npt.NDArray[numpy.bool_]: ...
    @staticmethod
...
class SJJunctions:
    ...
    def overlaps(
        self, sj_idx: npt._ArrayLikeInt_co, other: SJJunctions
    ) -> npt.NDArray[numpy.bool_]: ...
...
class SpliceGraphReads:
    def __init__(
        ...
        introns: GeneIntrons,
        junctions: GeneJunctions,
        introns_values: npt._ArrayLikeFloat_co,
        junctions_values: npt._ArrayLikeFloat_co,
    ) -> None: ...
    @staticmethod
    def from_sj(
        introns: GeneIntrons,
...
class SpliceGraphMask:
    def __init__(
        ...
        introns: GeneIntrons,
        junctions: GeneJunctions,
        introns_values: npt._ArrayLikeBool_co,
        junctions_values: npt._ArrayLikeBool_co,
    ) -> None: ...
    @property
    def _introns(self) -> GeneIntrons: ...
    @property
